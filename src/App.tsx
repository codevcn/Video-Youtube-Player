      ...
      <header className="bg-white dark:bg-zinc-950 border-b border-zinc-200 dark:border-zinc-800 relative top-0 z-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-(--main-cl) flex items-center justify-center text-white font-bold text-xl shadow-md border border-white/20">
              YP
            </div>
            <h1 className="text-xl font-bold tracking-tight text-zinc-800 dark:text-white">YouTube Subtitle Player</h1>
          </div>
        </div>
      </header>
